            ...
            try {
                ...
                if (3 == aIUIMessage.arg1) {
                    ...
                    if (jSONObject2.has(AIUIConstant.KEY_UID)) {
                        str = jSONObject2.optString(AIUIConstant.KEY_UID);
                    } else {
                        str = ac.b();
                        if (!TextUtils.isEmpty(str)) {
                            jSONObject2.put(AIUIConstant.KEY_UID, str);
                        }
                    }
                    if (jSONObject2.has("id_name")) {
                        ...
                        } else if (AIUIConstant.KEY_UID.equals(string) && TextUtils.isEmpty(optString2)) {
                    ...
                    if (jSONObject3.has(AIUIConstant.KEY_NLP_USER_DATA)) {
                        ...
                        if (jSONObject.has(AIUIConstant.KEY_UID)) {
                            optString = jSONObject.getString(AIUIConstant.KEY_UID);
                            if (TextUtils.isEmpty(optString)) {
                                optString = ac.b();
                                jSONObject.put(AIUIConstant.KEY_UID, optString);
                            }
                        } else {
                            optString = ac.b();
                            jSONObject.put(AIUIConstant.KEY_UID, optString);
