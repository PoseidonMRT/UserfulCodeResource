...
public class AppLinkNavigation {
    ...
    final class AnonymousClass1 implements Continuation<AppLink, NavigationResult> {
    ...
    private void sendAppLinkNavigateEventBroadcast(Context context, Intent intent, NavigationResult navigationResult, JSONException jSONException) {
        ...
        if (jSONException != null) {
            hashMap.put(ParamStr.RET_RES_ERROR, jSONException.getLocalizedMessage());
        }
    ...
    public static Task<NavigationResult> navigateInBackground(Context context, Uri uri, AppLinkResolver appLinkResolver) {
        return appLinkResolver.getAppLinkFromUrlInBackground(uri).onSuccess(new AnonymousClass1(context), Task.UI_THREAD_EXECUTOR);
    }
