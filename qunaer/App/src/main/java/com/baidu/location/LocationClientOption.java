...
public final class LocationClientOption {
    ...
    public String host = "loc.map.baidu.com";
    ...
    public LocationClientOption(LocationClientOption locationClientOption) {
        ...
        this.host = locationClientOption.host;
        this.proxyHost = locationClientOption.proxyHost;
        this.proxyPort = locationClientOption.proxyPort;
    }
    ...
    public void setOpenAutoNotifyMode(int i, int i2, int i3) {
        ...
        if (i4 < MIN_AUTO_NOTIFY_INTERVAL) {
            throw new IllegalArgumentException("Illegal this maxLocInterval : " + i4 + " , maxLocInterval must >= " + MIN_AUTO_NOTIFY_INTERVAL);
        }
        switch (i3) {
            case 1:
