...
public class ca {
    ...
    final class AnonymousClass1 implements Runnable {
        ...
        public void run() {
            ca.c(this.a, "iflytek.deviceid.key", this.b);
        }
    }
    ...
    final class AnonymousClass2 implements Runnable {
        ...
        public void run() {
            ca.c(this.a, "iflytek.deviceid.key", this.b);
            ca.d(this.a, ".2F6E2C5B63F0F83B", this.b);
        }
    }
    ...
    final class AnonymousClass3 implements Runnable {
        ...
        public void run() {
            ca.c(this.a, "iflytek.deviceid.key", this.b);
            ca.d(this.a, ".2F6E2C5B63F0F83B", this.b);
            ca.c(this.a, "com.iflytek.id", "pref.deviceid.key", this.b);
        }
    }
    ...
    private static String b(Context context) {
        ...
        if (a(a)) {
            ...
            if (a(a)) {
                a = c(context);
                new Thread(new AnonymousClass3(context, a)).start();
                return a;
            }
            new Thread(new AnonymousClass2(context, a)).start();
            return a;
        }
        new Thread(new AnonymousClass1(context, a)).start();
        return a;
    }
