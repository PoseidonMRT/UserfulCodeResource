...
public final class c {
                    ...
                    try {
                        ...
                        if (bundle != null) {
                            ...
                            if (!TextUtils.isEmpty(string)) {
                                byte[] a = com.baidu.location.b.a.b.a(string.getBytes("utf-8"));
                                ...
                                if (z) {
                                    ...
                                    if (!TextUtils.isEmpty(string2)) {
                                        ...
                                        if (a(strArr, a(packageInfo.signatures))) {
                                            byte[] a2 = a(com.baidu.location.b.a.b.a(string2.getBytes()), this.c);
    ...
    private void a() {
        ...
        try {
            byteArrayInputStream2 = new ByteArrayInputStream(b.a());
            try {
    ...
    private b b() {
        ...
        if (e == null) {
            ...
            b bVar = new b();
            str2 = b(this.a);
            bVar.a = com.baidu.location.b.a.c.a((VERSION.SDK_INT < 23 ? str + str2 + UUID.randomUUID().toString() : "com.baidu" + str2).getBytes(), true);
            bVar.b = str;
            a = bVar;
        } else {
            a = e;
    ...
    private static void b(String str, String str2) {
        if (!TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                fileWriter.write(com.baidu.location.b.a.b.a(com.baidu.location.b.a.a.a("30212102dicudiab", "30212102dicudiab", stringBuilder.toString().getBytes()), "utf-8"));
                fileWriter.flush();
                fileWriter.close();
            } catch (IOException e) {
            } catch (Exception e2) {
    ...
    private b d() {
        ...
        if (TextUtils.isEmpty(b)) {
            b = b(com.baidu.location.b.a.c.a(("com.baidu" + b2 + b(this.a)).getBytes(), true));
        }
        if (TextUtils.isEmpty(b)) {
            return null;
        }
    ...
    private b d(String str) {
        ...
        try {
            ...
            String[] split = new String(com.baidu.location.b.a.a.b("30212102dicudiab", "30212102dicudiab", com.baidu.location.b.a.b.a(stringBuilder.toString().getBytes()))).split("=");
    ...
    private b e() {
        ...
        if (file.exists()) {
            ...
            if (!TextUtils.isEmpty(a)) {
                try {
                    return b.a(new String(com.baidu.location.b.a.a.b("30212102dicudiab", "30212102dicudiab", com.baidu.location.b.a.b.a(a.getBytes()))));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
