...
public class m implements l {
    ...
    public Uri a(File file) {
        try {
            ...
            return new Builder().scheme(AIUIConstant.KEY_CONTENT).authority(this.a).encodedPath(Uri.encode((String) entry.getKey()) + IOUtils.DIR_SEPARATOR_UNIX + Uri.encode(path, "/")).build();
        } catch (IOException e) {
