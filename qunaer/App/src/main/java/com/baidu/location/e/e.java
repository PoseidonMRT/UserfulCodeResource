...
final class e {
        ...
        public a(String[] strArr) {
            ...
            while (i < strArr.length) {
                if (strArr[i].equals("-loc")) {
                    ...
                    for (int i3 = 0; i3 < split.length; i3++) {
                        if (split[i3].startsWith("cl=")) {
                            ...
                            for (String split3 : split2) {
                                String[] split4 = split3.split(VoiceWakeuperAidl.PARAMS_SEPARATE);
                                if (split4.length >= 2) {
                    ...
                    String[] split5 = strArr[i + 1].split(VoiceWakeuperAidl.PARAMS_SEPARATE);
                    if (split5.length > 0) {
                    ...
                    try {
                        if (strArr[i].equals("-des") && strArr[i + 1].equals("true")) {
                            z = true;
                        }
                    } catch (Exception e3) {
                    }
    ...
    static Cursor a(BDLocation bDLocation) {
        ...
        String str6;
        String str7;
        String format = new SimpleDateFormat(DateTimeUtils.yyyy_MM_dd_HH_mm_ss, Locale.US).format(new Date(System.currentTimeMillis()));
                ...
                if (str5 != null) {
                    try {
                        ...
                        for (String str82 : split) {
                            String[] split2 = str82.split(VoiceWakeuperAidl.PARAMS_SEPARATE);
                            if (split2.length >= 3) {
    ...
    static String a(BDLocation bDLocation, int i) {
        ...
        return str + String.format(Locale.US, "&pack=%s&sdk=%.3f", new Object[]{c.d, Float.valueOf(6.33f)});
    }
    ...
    static String[] a(com.baidu.location.f.a aVar, i iVar, BDLocation bDLocation, String str, boolean z, int i) {
        ...
        if (com.baidu.location.h.i.f.equals(SpeechConstant.PLUS_LOCAL_ALL)) {
            arrayList.add("-rgc");
            arrayList.add("true");
        }
        if (com.baidu.location.h.i.k) {
            arrayList.add("-poi");
            arrayList.add("true");
        }
        if (com.baidu.location.h.i.j) {
            arrayList.add("-des");
            arrayList.add("true");
        }
        arrayList.add("-minap");
