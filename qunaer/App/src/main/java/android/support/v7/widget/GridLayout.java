...
public class GridLayout extends ViewGroup {
    ...
    final class AnonymousClass5 extends Alignment {
    ...
    final class Axis {
        ...
        private void shareOutDelta() {
            ...
            while (i2 < childCount) {
                ...
                if (f2 != 0.0f) {
                    f2 += f;
                    access$300 = i3 + (GridLayout.this.getMeasurement(childAt, this.horizontal) - getOriginalMeasurements()[i2]);
                } else {
                    f2 = f;
                    access$300 = i3;
                }
    ...
    private int getDefaultMargin(View view, LayoutParams layoutParams, boolean z, boolean z2) {
        ...
        boolean z4 = i != 0 ? interval.min == 0 ? DEFAULT_ORDER_PRESERVED : false : interval.max == axis.getCount() ? DEFAULT_ORDER_PRESERVED : false;
    ...
    private static Alignment createSwitchingAlignment(Alignment alignment, Alignment alignment2) {
        return new AnonymousClass5(alignment, alignment2);
    }
