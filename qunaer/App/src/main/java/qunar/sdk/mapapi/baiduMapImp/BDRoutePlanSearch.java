    ...
    public void onGetDrivingRouteResult(DrivingRouteResult drivingRouteResult) {
        ...
        if (this.routePlanCallback != null) {
            if (this.isCancle) {
                ...
                int i = 0;
                for (DrivingStep wayPoints : allStep) {
                    int size;
                ...
                if (i > 2 && i < LocationClientOption.MIN_AUTO_NOTIFY_INTERVAL) {
                    DrivingRouteOverlay myDrivingRouteOverlay = new MyDrivingRouteOverlay(this.bdMap);
    ...
    public void onGetBikingRouteResult(BikingRouteResult bikingRouteResult) {
        ...
        if (this.routePlanCallback != null) {
            if (this.isCancle) {
                ...
                List<BikingStep> allStep = bikingRouteLine.getAllStep();
                if (allStep == null || allStep.isEmpty() || this.bdMap == null) {
                    this.routePlanCallback.onRoutePlanCallback(false, "抱歉，未找到合适的路线！", null, 0);
                    return;
                }
                ...
                int i = 0;
                for (BikingStep wayPoints : allStep) {
                    int size;
                    List wayPoints2 = wayPoints.getWayPoints();
                    if (wayPoints2 != null) {
                        size = wayPoints2.size() + i;
                ...
                if (i > 2 && i < LocationClientOption.MIN_AUTO_NOTIFY_INTERVAL) {
                    BikingRouteOverlay myBikingRouteOverlay = new MyBikingRouteOverlay(this.bdMap);
    ...
    public void onGetTransitRouteResult(TransitRouteResult transitRouteResult) {
        ...
        if (this.routePlanCallback != null) {
            if (this.isCancle) {
                ...
                int i = 0;
                for (TransitStep wayPoints : allStep) {
                    int size;
                    List wayPoints2 = wayPoints.getWayPoints();
                    if (wayPoints2 != null) {
                        size = wayPoints2.size() + i;
                ...
                if (i > 2 && i < LocationClientOption.MIN_AUTO_NOTIFY_INTERVAL) {
                    TransitRouteOverlay myTransitRouteOverlay = new MyTransitRouteOverlay(this.bdMap);
    ...
    public void onGetWalkingRouteResult(WalkingRouteResult walkingRouteResult) {
        ...
        if (this.routePlanCallback != null) {
            if (this.isCancle) {
                ...
                this.routePlanCallback.routeAnalysisEndCallback(RoutePlaneResultType.SUCCESS);
                removeFromMap();
                RouteLine routeLine = (WalkingRouteLine) routeLines.get(0);
                ...
                for (i = 1; i < routeLines.size(); i++) {
                    if (distance > ((WalkingRouteLine) routeLines.get(i)).getDistance()) {
                        ...
                        routeLine2 = (WalkingRouteLine) routeLines.get(i);
                    }
                }
                List<WalkingStep> allStep = routeLine2.getAllStep();
                if (allStep == null || allStep.isEmpty() || this.bdMap == null) {
                    this.routePlanCallback.onRoutePlanCallback(false, "抱歉，未找到合适的路线！", null, 0);
                    return;
                }
                this.route = routeLine2;
                i = 0;
                ...
                if (i > 2 && i < LocationClientOption.MIN_AUTO_NOTIFY_INTERVAL) {
                    WalkingRouteOverlay myWalkingRouteOverlay = new MyWalkingRouteOverlay(this.bdMap);
                    this.overlayManager = myWalkingRouteOverlay;
                    this.bdMap.setOnMarkerClickListener(myWalkingRouteOverlay);
                    myWalkingRouteOverlay.setData(routeLine2);
