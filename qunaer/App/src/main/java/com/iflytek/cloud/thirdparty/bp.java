...
public class bp {
    ...
    final class AnonymousClass1 implements Callback {
        ...
        public boolean handleMessage(Message message) {
            switch (message.what) {
                case 1:
                    bp.f = new WebView(this.a).getSettings().getUserAgentString();
    ...
    public static String e(Context context) {
        if (TextUtils.isEmpty(f)) {
            try {
                new Handler(context.getMainLooper(), new AnonymousClass1(context)).sendEmptyMessage(1);
            } catch (Throwable th) {
                cb.a(th);
            }
        }
    ...
    private static void g(Context context) {
        try {
            ...
            d.a("os.resolution", displayMetrics.widthPixels + Contact.OTHER + displayMetrics.heightPixels);
