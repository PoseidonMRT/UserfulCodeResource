...
public class JavaBeanDeserializer implements ObjectDeserializer {
    ...
    public <T> T deserialzeArrayMapping(DefaultJSONParser defaultJSONParser, Type type, Object obj, Object obj2) {
        ...
        if (lexer.token() != 14) {
            throw new JSONException(ParamStr.RET_RES_ERROR);
        }
...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Exception block dominator not found, method:com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.deserialze(com.alibaba.fastjson.parser.DefaultJSONParser, java.lang.reflect.Type, java.lang.Object, java.lang.Object):T. bs: [B:58:0x00d7, B:166:0x02d7, B:181:0x031b]
...
*/
    ...
    L_0x0020:
        ...
        if (r1 != r3) goto L_0x003e;	 Catch:{ all -> 0x00a2 }
    L_0x002a:
        r1 = 16;	 Catch:{ all -> 0x00a2 }
        r9.nextToken(r1);	 Catch:{ all -> 0x00a2 }
        if (r14 != 0) goto L_0x0035;	 Catch:{ all -> 0x00a2 }
    L_0x0031:
