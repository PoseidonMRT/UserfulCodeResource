...
public final class h {
                    ...
                    if (str != null && str.length() > 0) {
                        if ("mounted".equals(method2.invoke(storageManager, new Object[]{str}))) {
                            ...
                            if (VERSION.SDK_INT <= 19 && a(str)) {
                                this.b.add(new g(str, obj2 == null, obj2 != null ? "Internal Storage" : "External Storage"));
                            }
                        }
                    }
                }
    ...
    L_0x00b4:
        ...
        r5 = new com.baidu.location.h.g;	 Catch:{ Exception -> 0x010a, all -> 0x0115 }
        r6 = 0;
        r7 = "Auto";
    ...
    L_0x00fc:
        ...
        r6 = new com.baidu.location.h.g;	 Catch:{ Exception -> 0x010a, all -> 0x0115 }
        r7 = 0;
        r8 = "Auto";
    ...
    L_0x011a:
        ...
        goto L_0x00ab;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.baidu.location.h.h.e():java.util.List<com.baidu.location.h.g>");
    }

    public String b() {
        List c = c();
        return (c == null || c.size() == 0) ? null : ((g) c.get(0)).a();
    }
