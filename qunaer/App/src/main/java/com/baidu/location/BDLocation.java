...
public final class BDLocation implements Parcelable {
    ...
    public static final Creator<BDLocation> CREATOR = new Creator<BDLocation>() {
    ...
    public static final int INDOOR_LOCATION_SURPPORT_UNKNOW = -1;
    ...
    public BDLocation() {
        ...
        this.mCu = "";
        this.mIndoorState = -1;
        this.mIndoorLocationSurpport = -1;
    ...
    public BDLocation(String str) {
        ...
        if (str != null && !str.equals("")) {
            try {
                ...
                int parseInt = Integer.parseInt(jSONObject2.getString(ParamStr.RET_RES_ERROR));
                setLocType(parseInt);
                setTime(jSONObject2.getString(QUNAR_GPS_FIELD.TIME_FIELD));
                JSONObject jSONObject3;
                if (parseInt == 61) {
                    jSONObject3 = jSONObject.getJSONObject(AIUIConstant.KEY_CONTENT);
                    jSONObject = jSONObject3.getJSONObject("point");
                    setLatitude(Double.parseDouble(jSONObject.getString(MapViewConstants.ATTR_Y)));
                    setLongitude(Double.parseDouble(jSONObject.getString(MapViewConstants.ATTR_X)));
                    ...
                    JSONObject jSONObject4 = jSONObject.getJSONObject(AIUIConstant.KEY_CONTENT);
