...
public class SpeechSynthesizerAidl extends SpeechModuleAidl<ISpeechSynthesizer> {
    ...
    public String getParameter(String str) {
        ...
        try {
            ...
            return serviceVersion >= 44 ? (serviceVersion < LocationClientOption.MIN_AUTO_NOTIFY_INTERVAL || serviceVersion >= SpeechEvent.EVENT_VAD_EOS) ? ((ISpeechSynthesizer) this.mService).getLocalSpeakerList() : null : null;
        } catch (Throwable e) {
            cb.a(e);
            return "20999";
        }
