...
public class af extends Handler {
    ...
    private void j() {
        this.a = ac.a();
        this.d = ac.a("interact", AIUIConstant.KEY_INTERACT_TIMEOUT, (int) LocationClientOption.MIN_AUTO_NOTIFY_INTERVAL);
        ...
        if (-1 != this.d) {
            if (this.d < LocationClientOption.MIN_AUTO_NOTIFY_INTERVAL) {
