        ...
        public void setCallback(final Callback callback, Handler handler) {
            if (callback != this.mCallback) {
                if (callback == null || VERSION.SDK_INT < 18) {
                    ...
                    android.support.v4.media.session.MediaSessionCompatApi14.Callback anonymousClass2 = new android.support.v4.media.session.MediaSessionCompatApi14.Callback() {
                        public void onStop() {
                            callback.onStop();
                        }
